...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(140px, 1fr)); gap: 16px; margin-bottom: 30px; }
        ...
        .section h2 { font-size: 15px; color: #94a3b8; margin-bottom: 12px; padding-bottom: 8px; border-bottom: 1px solid #1e293b; }
        table { width: 100%; border-collapse: collapse; background: #1e293b; border-radius: 10px; overflow: hidden; }
        th { background: #334155; padding: 12px 16px; font-size: 13px; text-align: right; }
        td { padding: 10px 16px; border-bottom: 1px solid #0f172a; font-size: 13px; }
        tr:last-child td { border-bottom: none; }
        .badge { display: inline-block; padding: 3px 10px; border-radius: 20px; font-size: 12px; }
        .badge.عالی  { background: #14532d; color: #86efac; }
        .badge.خوب   { background: #1e3a5f; color: #93c5fd; }
        .badge.متوسط { background: #3f3a00; color: #fde68a; }
        .badge.ضعیف  { background: #4c0519; color: #fca5a5; }
    </style>
</head>
<body>
...
<div class="section">
    <h2>📝 نظرسنجی‌ها</h2>
    <table>
        <tr><th>نام کاربر</th><th>نظر</th><th>تاریخ</th></tr>
